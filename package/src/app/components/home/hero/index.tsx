        ...
        <div className='container relative z-10'>
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            <div
              ...
              <h1 className="text-dark_black dark:text-white">
                <TextGenerateEffect words="Innovative solutions for bold brands" />
              </h1>
              <p className='max-w-38 text-dark_black/60 dark:text-white/60'>
                Curvvtech is a tech agency that delivers software development,
                cloud solutions, and digital innovation—helping startups and
                enterprises scale from idea to launch.
              </p>
            </div>
