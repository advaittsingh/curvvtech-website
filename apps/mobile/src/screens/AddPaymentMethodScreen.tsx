...
import type { AddPaymentMethodScreenProps } from "../navigation/types";
  ...
  return (
    <View style={[styles.screen, { paddingTop: 8, paddingBottom: insets.bottom + 24 }]}>
      ...
      <View style={styles.card}>
        <Ionicons name="wallet-outline" size={48} color={colors.textMuted} style={styles.icon} />
        <Text style={styles.title}>Coming soon</Text>
        <Text style={styles.body}>
          Adding a payment method will be available once checkout is live. Nothing is saved here yet.
        </Text>
      </View>
    </View>
  );
