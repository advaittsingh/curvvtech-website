    ...
    return (
        <>
            ...
            <div className="p-6 rounded-md border mt-4 border-border dark:border-dark_border">
                <p className="text-base font-medium text-midnight_text dark:text-grey" >1. Change Font family over here : <span className="font-semibold text-base">styles/globals.css</span>  </p>
