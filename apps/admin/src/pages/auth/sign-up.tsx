...
export default function SignUp() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError("Check your email or try signing in.");
    } catch {
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-stone-50 py-12 px-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <p className="text-stone-600 text-sm mt-1">Uses the unified API. Ask an owner to grant you admin role in the database.</p>
        </div>
        ...
        <p className="text-center text-sm text-stone-600">
          <Link to="/auth/sign-in" className="text-stone-800 hover:underline font-medium">
